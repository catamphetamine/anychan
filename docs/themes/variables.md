...
* `--CommentSeparator-color: gray` — Comments separator line color (on thread page).
* `--CommentSeparator-color--largeScreen: gray` — Comments separator line color (on thread page) (on large screens).
* `--CommentSeparator-color--channelPage: gray` — Comments separator line color (on channel page).
* `--CommentSeparator-color--channelPageLargeScreen: gray` — Comments separator line color (on channel page) (on large screens).
