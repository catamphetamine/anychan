...
<!-- * `--PostQuote-spacing: 0px` — The spacing between the "blocks" of a post quote. Each block is marked by a `PostQuoteMarker` (a vertical line on the left side of a quote). -->
* `--PostQuote-marginTop: 0px` — The vertical (top and bottom) margin of a post quote. When a post quote has a background then the content is usually more readable with some additional vertical margin, and also this way consequtive post quotes don't look like a single one.
...
* `--PostQuote-color--generated`
* `--PostQuote-backgroundColor--generated`
* `--PostQuote-backgroundColor--generated--hover`
* `--PostQuote-borderColor--generated`
<!-- * `--PostQuote-borderColor--generated--hover` -->
<!-- * `--PostQuote-spacing--generated` -->
* `--PostQuote-marginTop--generated`
...
For autogenerated post links there're the same style variables for `PostQuoteMarker` but ending with a `--generated` postfix.

* `--PostQuoteMarker-color--generated`
* `--PostQuoteMarker-opacity--generated`
* `--PostQuoteMarker-width--generated`
* `--PostQuoteMarker-padding--generated`
