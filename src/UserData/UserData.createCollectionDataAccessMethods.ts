import type { UserDataCollections, UserDataCollection, UserDataChunkData, UserDataChunkItemData, UserDataOperation } from '@/types'
...
export default function createDataAccessMethods({
	...
	for (const collectionName of Object.keys(collections)) {
		...
		const addMethod = (op: UserDataOperation) => {
			...
			this[getMethodName(op, collection.name)] = (...args: any[]) => {
				this._onDataAccess()
