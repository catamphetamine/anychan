export function setChannelIdThreadIdCommentIds({ encode }, _,channelIdThreadIdCommentIds) {
	return channelIdThreadIdCommentIds
}

export function addToChannelIdThreadIdCommentIds(
	{ encode },
	channelIdThreadIdCommentIds = {},
	channelId,
	threadId,
	commentId
) {
...
export function removeFromChannelIdThreadIdCommentIds(
	{ key },
	channelIdThreadIdCommentIds,
	channelId,
	threadId,
...
export function getFromChannelIdThreadIdCommentIds(
	{ decode },
	channelIdThreadIdCommentIds = {},
	channelId,
	threadId,
...
export function mergeWithChannelIdThreadIdCommentIds(
	{ key },
	channelIdThreadIdCommentIds = {},
	data
) {
