...
export function getResourceMessages(messages: Messages) {
	return {
		videoNotFound: messages && messages.post && messages.post.videoNotFound
	}
}

export function onCommentContentChange(comment: Comment, {
	getCommentById,
	renderComments
}: {
	getCommentById?: (commentId: Comment['id']) => Comment | undefined,
	renderComments?: (commentIds: Array<Comment['id']>) => void
}) {
