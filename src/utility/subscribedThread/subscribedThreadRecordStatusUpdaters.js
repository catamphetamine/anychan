export function onStartLocked(subscribedThread) {
...
export function onStopLocked(subscribedThread) {
	delete subscribedThread.locked
	delete subscribedThread.lockedAt
}

export function onStartTrimming(subscribedThread) {
...
export function onStopTrimming(subscribedThread) {
	delete subscribedThread.trimming
	// `commentsCount` and `latestComment` are set in the parent function.
}

export function onStartArchived(subscribedThread, archivedAt) {
...
export function onStopArchived(subscribedThread) {
	delete subscribedThread.archived
	delete subscribedThread.archivedAt
}

export function onStartExpired(subscribedThread) {
...
export function onStopExpired(subscribedThread) {
