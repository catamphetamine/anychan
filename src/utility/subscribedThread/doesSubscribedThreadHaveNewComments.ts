 ...
 * @param  {string} [options.type] — Comment type.
 ...
 */
export default function doesSubscribedThreadHaveNewComments(subscribedThread: SubscribedThread, {
	type,
	userData
}: {
	type?: 'reply',
	...
	switch (type) {
		case 'reply':
			return subscribedThreadState.newRepliesCount > 0
		default:
			if (type) {
