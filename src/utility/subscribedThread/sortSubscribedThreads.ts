 ...
 */
export default function sortSubscribedThreads(
 ...
 */
export function compareSubscribedThreads(a: SubscribedThread, b: SubscribedThread, { userData }: { userData: UserData }) {
 ...
 */
function compareSubscribedThreadsByRating(a: SubscribedThread, b: SubscribedThread, { userData }: { userData: UserData }) {
...
function compareSubscribedThreadsNoNewComments(a: SubscribedThread, b: SubscribedThread) {
...
function compareSubscribedThreadsFinal(a: SubscribedThread, b: SubscribedThread) {
...
//
function compareSubscribedThreadsByNewCommentsCount(
	a: SubscribedThread,
	b: SubscribedThread,
	aNewCommentsCount: number,
	bNewCommentsCount: number
) {
...
function agingFactor(age: number) {
