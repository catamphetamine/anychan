 ...
 * @param  {string} options.asteriskOneOrMoreCharacters — If an asterisk ("*") should be treated as "one or more characters" instead of the default "zero or more characters".
 * @return {boolean}
 */
export default function matchesPattern(string, pattern, { asteriskExcludeCharacter, asteriskOneOrMoreCharacters } = {}) {
