...
import type { SubscribedThreadsView } from './useSubscribedThreads.js'
...
export default function useViewMode({
	...
	const [viewMode, setViewMode] = useState<SubscribedThreadsView>(getViewMode())
