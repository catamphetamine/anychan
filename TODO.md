* Картинки постов: не вписывать их в прямоугольник FullHD, а показывать полностью, подгоняя под одну высоту, и выстраивая в ряд (не растягивая по ширине, и так сойдёт).
...
* Вынести название доски и её описание во floating header.

* Сделать крутилку (loading global) при нажатии на доску.
...
* Выводить количество комментариев со ссылкой (мб с промоткой).

* Maintain thumbnail aspect ratio for attachments.
