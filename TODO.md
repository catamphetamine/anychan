...
Try adding a git tag 0.1.0 and maybe add a link to download builds in the readme.
...
Test create git tag and see if a resource is generated.

Latest build URL:
https://gitlab.com/catamphetamine/captchan/-/jobs/artifacts/master/download?job=build

Написать в ридми ссылку на GitLab releases, и может быть ссылку на Latest Build `*.zip`.
